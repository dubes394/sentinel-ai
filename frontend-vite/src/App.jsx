            ...
            <div>
              ...
              <Card>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 16 }}>
                  ...
                  <Metric label="Financial Exposure" value={investigation.scope.financial_exposure_cad >= 1000000? `$${(investigation.scope.financial_exposure_cad / 1000000).toFixed(1)}M`: investigation.scope.financial_exposure_cad >= 1000? `$${(investigation.scope.financial_exposure_cad / 1000).toFixed(1)}K` : `$${investigation.scope.financial_exposure_cad}`} sub="CAD" color="#f6ad55" />
